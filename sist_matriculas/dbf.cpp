...
vector<string>* DBF::select_all_of(int field, string value)
{
    ...
    vector<string> *row=new vector<string>(m_nNumFields);
...
{
    cout<<m_FileHeader.uRecordsInFile<<endl;
    cout<<m_nNumFields<<endl;
    vector<vector<string> *> *matriz=new vector<vector<string> *>(m_nNumFields);

    for(int i=0;i<m_nNumFields;i++)
    {
        (*matriz)[i]=new vector<string>(m_FileHeader.uRecordsInFile);
    }
